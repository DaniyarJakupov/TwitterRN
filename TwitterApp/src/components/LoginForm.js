...
import LOGIN_MUTATION from '../graphql/mutation/login'; // graphql mutation
...
class LoginForm extends Component {
  ...
  onConfirmPress = async () => {
    ...
    try {
      ...
      await AsyncStorage.setItem('@customtwittertoken', data.login.token);
...
export default compose(graphql(LOGIN_MUTATION), connect(undefined, { userLogin }))(LoginForm);
